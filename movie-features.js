...
const cards = [
    ...
    { name: 'Tony Montana', movie: 'Scarface' },
    { name: 'Michael Corleone', movie: 'The Godfather Part II' },
    { name: 'Travis Bickle', movie: 'Taxi Driver' },
    { name: 'Rocky Balboa', movie: 'Rocky' },
    { name: 'John McClane', movie: 'Die Hard' },
    { name: 'Sarah Connor', movie: 'The Terminator' },
    { name: 'T-800', movie: 'Terminator 2: Judgment Day' },
    { name: 'Neo', movie: 'The Matrix' },
    { name: 'Morpheus', movie: 'The Matrix' },
    { name: 'The Joker', movie: 'The Dark Knight' },
    { name: 'Bruce Wayne', movie: 'The Dark Knight' },
    { name: 'Diana Prince', movie: 'Wonder Woman' },
    { name: 'Peter Parker', movie: 'Spider-Man 2' },
    { name: 'Logan', movie: 'Logan' },
    { name: 'Tony Stark', movie: 'Iron Man' },
    { name: 'Steve Rogers', movie: 'Captain America: The Winter Soldier' },
    { name: 'Thanos', movie: 'Avengers: Infinity War' },
    { name: 'Luke Skywalker', movie: 'Star Wars' },
    { name: 'Darth Vader', movie: 'The Empire Strikes Back' },
    { name: 'Princess Leia', movie: 'Star Wars' },
    { name: 'Jack Sparrow', movie: 'Pirates of the Caribbean: The Curse of the Black Pearl' },
    { name: 'James Bond', movie: 'Casino Royale' },
    { name: 'Jason Bourne', movie: 'The Bourne Identity' },
    { name: 'Ethan Hunt', movie: 'Mission: Impossible - Fallout' },
    { name: 'Harry Potter', movie: 'Harry Potter and the Sorcerer\'s Stone' },
    { name: 'Hermione Granger', movie: 'Harry Potter and the Prisoner of Azkaban' },
    { name: 'Frodo Baggins', movie: 'The Lord of the Rings: The Fellowship of the Ring' },
    { name: 'Gandalf', movie: 'The Lord of the Rings: The Return of the King' },
    { name: 'Aragorn', movie: 'The Lord of the Rings: The Two Towers' },
    { name: 'Katniss Everdeen', movie: 'The Hunger Games' },
    { name: 'Willy Wonka', movie: 'Willy Wonka & the Chocolate Factory' },
    { name: 'Forrest Gump', movie: 'Forrest Gump' },
    { name: 'Andy Dufresne', movie: 'The Shawshank Redemption' },
    { name: 'Dr. Hannibal Lecter', movie: 'The Silence of the Lambs' },
    { name: 'Patrick Bateman', movie: 'American Psycho' },
    { name: 'Mia Wallace', movie: 'Pulp Fiction' },
    { name: 'Vincent Vega', movie: 'Pulp Fiction' },
    { name: 'Mufasa', movie: 'The Lion King' },
    { name: 'Simba', movie: 'The Lion King' },
    { name: 'Woody', movie: 'Toy Story' },
    { name: 'Shrek', movie: 'Shrek' },
    { name: 'Po', movie: 'Kung Fu Panda' },
    { name: 'Chihiro', movie: 'Spirited Away' },
    { name: 'Totoro', movie: 'My Neighbor Totoro' }
];
const genres = {
